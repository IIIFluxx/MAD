...
public class StructureData
{
    ...
    private List<Structure> structureList = Arrays.asList(new Structure[] {
        ...
        new Commercial(R.drawable.ic_building6, "Commercial"),
        new Commercial(R.drawable.ic_building7, "Commercial"),
        ...
        new Road(R.drawable.ic_road_sew, "Road"),
            ...
            // Treated as a Residential object.
        new Residential(R.drawable.ic_tree1, "Tree"),
        new Residential(R.drawable.ic_tree2, "Tree"),
        new Residential(R.drawable.ic_tree3, "Tree"),
        new Residential(R.drawable.ic_tree4, "Tree"),
    });
